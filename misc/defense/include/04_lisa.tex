...
\begin{frame}{Übersetzung}
	\begin{bigitemize}{3mm}
		...
		\note[item]{Direkte Übersetzung bei Extensions}
		\note[item]{Kopieren bei Inheritance}
		\note[item]{Parametrisierung ohne Type Erasures!}
		\note[item]{Inheritance und Parametrisierung verwendet \emph{Name Mangling}}
		\note[item]{Typen-Information zur Laufzeit}
		\note[item]{Beispiel wird in Demo gezeigt}
	\end{bigitemize}
\end{frame}
%
