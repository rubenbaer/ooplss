...
\begin{frame}{Begriffe}
	...
	\end{bigdescription}
		\note[item]{Nominal Type System, Kompatibilität von Typen wird explizit deklariert}
		\note[item]{Structural Type System, Kompatibilität wird implizit durchgeführt}
		\note[item]{Derivation, Beinhaltet beides, \emph{Extension} und \emph{Inheritance}}
		\note[item]{Extension, Generiert Subtypen}
		\note[item]{Inheritance, Generiert Subklassen}
		\note[item]{Subtyping, Typenrelation für Typen-Polymorphimus}
		\note[item]{Matching, Schwächere Typenrelation als Subtyping}
		\note[item]{Subclassing, Klassenerweiterung für Matching}
\end{frame}
...
\begin{frame}{Subtyping}
	\begin{bigitemize}[<+->]{3mm}
		...
		\note[item]<5>{Was heisst das?}

		\item Typenunsichere binäre Methoden
