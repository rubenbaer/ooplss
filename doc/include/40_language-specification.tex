...
observing the listings \todo{reference} one may see something rather
...
This code is illegal because \self is of type \B and
...
\todo{Self is a MyType but not type of class it self.}
