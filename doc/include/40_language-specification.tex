...
%combination via inheritance breaks the subtype hierarchy and does
%only provide the possibility of code reuse. Different to other
%combination possibilities binds subclassing \mytype after the
%combination. This enables the possibility to specialise binary
%methods. 
%
%\Cref{fig:inheritHierarchy}
