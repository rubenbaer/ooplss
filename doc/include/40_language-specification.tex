...
From this thoughts, the \cpp templates might be a good choice for
...
in \cpp the for every class a new inner class is created with special
...
\begin{lstlisting}[float=h,language=ooplss,caption=Explicit \mytype parametrisation,label=lst:explicitMyType]
class A[MyType <# A] {
	def m(o : MyType) MyType {
