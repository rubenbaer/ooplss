...
% TODO: If any time. Write this here...
%\subsection{Implicitly Parametrised Classes with \mytype}
%At last in this section about parametrisation lets consider the \mytype
%construct. 
%
%
%\begin{lstlisting}[float,language=ooplss,caption=Extending a container class translated to Java,label=lst:extendingContainer]
%class A[MyType$A$ <# A] {
%	var self : MyType$A$;
%	def m(o : MyType$A$) MyType$A$ {
%		return self;
%	}
%}
%
%class B[MyType$B$ <# B, MyType$A$ <# A] subtypeOf A[MyType$A$] {
%	%\ldots)
%}
%
%class C[MyType$C$ <# C] subclassOf A[MyType$C$] {
%	%\ldots)
%}
%
%\end{lstlisting}
