...
implementation and the second a ordered library. Both presented different
difficulties within software composition and typing. Of course it can
not be compared between Scala and \ooplss but theses examples shows that
some problems in other languages can be tackled by Scala as well as by
\ooplss. With the possibility of subclassing a mechanism for software
combination is introduced which can be used very powerful in suitable
situations.
