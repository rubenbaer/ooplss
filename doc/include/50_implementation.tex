...
define both, grammars for string, 1-dimensional, and for abstract syntax
trees which are 2-dimensional. In ANTLR these are known as \emph{tree
...
used for tree rewriting respectively tree visiting.  The output process
...
If not, a default constructor symbol is created and assigned to the
class.
...
variables or using types that do not exist.
