...
sequential design process. It is not intended to show where exactly tasks were
began and finished. However, it shows at which time of the project we had
...
checker. This gives the opportunity to sequentially add new features to the
language.
