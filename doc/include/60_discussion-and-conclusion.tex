...
\subsubsection{Method Overloading and Multiple Inheritance}
...
\subsubsection{Matching as Higher-Order Subtyping}
...
is also considered as higher-order subtyping which brings additional
...
\subsubsection{Syntax Inference}
