...
the equals method/function takes an Object and returns a Boolean\todo{Also introduced before}}
...
\begin{figure}
	...
	\digraph[scale=0.7]{NaiveRecursion}{
		rankdir=LR;
		margin=0;
	...
	\digraph[scale=0.7]{MutualRecursion}{
		rankdir=LR;
		margin=0;
		c[fontname=LMRoman10,label=client,shape=plaintext]
		a[fontname=LMRoman10,label=M,shape=Mrecord];
