...
\emph{derivation}\nomenclature{Derivation}{Refers to both, extension and
inheritance. A class combination aims to code reuse} is used to refer
...
together simply called \emph{fields}\nomenclature{Field}{Is a field
within a record respectively a map and can be both, a method or a data
...
obey boundaries of a subtype relation} The goal of the concept of
...
\Cref{sec:schizoReferences}} Here, the problem is that passing the own
