...
\begin{description}
	...
	\begin{figure}[H]
		...
		\end{emp}
		\caption{Covariant method return types}
	...
	then does $m^\prime$ can be of type $X \rightarrow T$ since the
	parameter type is contravariant to \B <: \A.
	\begin{figure}[H]
		\centering
		\begin{emp}[classdiag](20, 20)

			Class.AA("A")()("+m(arg: B):T");
			Class.BB("B")()("+m(arg: A):T");
		...
		\end{emp}
		\caption{Contravariant method parameter types}
